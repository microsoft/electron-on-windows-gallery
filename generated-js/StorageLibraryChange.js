...
const { StorageLibraryChangeType } = require('./StorageLibraryChangeType');
...
class StorageLibraryChange {
    ...
    async getStorageItemAsync() {
        return new IStorageItem((await _IStorageLibraryChange.method(10).invoke(this._obj, []).toPromise()));
    }
}
