...
class StorageFileQueryResult {
    ...
    async getFilesAsync(operation, startIndex) {
        return new IVectorView_StorageFile((await _IStorageFileQueryResult.method(6).invoke(this._obj, [DynWinRtValue.i32(operation), DynWinRtValue.i32(startIndex)]).toPromise()));
    }

    async getFilesAsyncDefaultStartAndCount() {
        return new IVectorView_StorageFile((await _IStorageFileQueryResult.method(7).invoke(this._obj, []).toPromise()));
    }
...
class IStorageFileQueryResult2 {
    ...
    getMatchingPropertiesWithRanges(result) {
        return new IMap_String_IVectorView_TextSegment(_IStorageFileQueryResult2.method(6).invoke(this._obj, [result._obj || result]));
    }
}
module.exports = { StorageFileQueryResult, IStorageQueryResultBase, IStorageFileQueryResult2 };
