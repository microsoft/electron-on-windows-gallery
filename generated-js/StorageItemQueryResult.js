...
class StorageItemQueryResult {
    ...
    async getItemsAsync(operation, startIndex) {
        return new IVectorView_IStorageItem((await _IStorageItemQueryResult.method(6).invoke(this._obj, [DynWinRtValue.i32(operation), DynWinRtValue.i32(startIndex)]).toPromise()));
    }

    async getItemsAsyncDefaultStartAndCount() {
        return new IVectorView_IStorageItem((await _IStorageItemQueryResult.method(7).invoke(this._obj, []).toPromise()));
    }
...
module.exports = { StorageItemQueryResult, IStorageQueryResultBase };
