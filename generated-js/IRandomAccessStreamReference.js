...
class IRandomAccessStreamReference {
    ...
    async openReadAsync() {
        return new _m_IRandomAccessStreamWithContentType.IRandomAccessStreamWithContentType((await _IRandomAccessStreamReference.method(6).invoke(this._obj, []).toPromise()));
    }
}
