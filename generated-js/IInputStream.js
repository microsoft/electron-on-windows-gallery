...
class IInputStream {
    ...
    readAsync(operation, buffer, count) {
        const _op = _IInputStream.method(6).invoke(this._obj, [operation._obj || operation, DynWinRtValue.i32(buffer), DynWinRtValue.i32(count)]);
        const _w = {
            progress(cb) { _op.onProgress(cb); return _w; },
            async toPromise() { return new _m_IBuffer.IBuffer(await _op.toPromise()); },
