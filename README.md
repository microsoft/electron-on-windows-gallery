...
This project uses [@microsoft/dynwinrt](https://github.com/microsoft/dynwinrt) to dynamically call Windows Runtime AI APIs from JavaScript. The bindings are generated by [@microsoft/winappcli](https://www.npmjs.com/package/@microsoft/winappcli) into `.winapp/bindings/` — one `.js` + `.d.ts` pair per emitted class, plus an `index.js` that re-exports everything.
...
| @microsoft/winappcli | 0.4.0 | CLI that drives package/binding generation |
| @microsoft/dynwinrt | 0.1.0-preview.6 | Runtime WinRT invocation layer ([npm](https://www.npmjs.com/package/@microsoft/dynwinrt)) |
| @microsoft/dynwinrt-codegen | 0.1.0-preview.6 | Build-time code generator ([npm](https://www.npmjs.com/package/@microsoft/dynwinrt-codegen)) |
