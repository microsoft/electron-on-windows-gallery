...
This project uses [@microsoft/dynwinrt](https://github.com/microsoft/dynwinrt) to dynamically call Windows Runtime AI APIs from JavaScript. The bindings are generated by [@microsoft/winappcli](https://www.npmjs.com/package/@microsoft/winappcli) into `.winapp/bindings/` and exposed through `#winapp/bindings` for both ESM imports and CommonJS requires.
...
| @microsoft/dynwinrt | 0.1.0-preview.17 | Runtime WinRT invocation layer ([npm](https://www.npmjs.com/package/@microsoft/dynwinrt)) |
| @microsoft/dynwinrt-codegen | 0.1.0-preview.17 | Build-time code generator ([npm](https://www.npmjs.com/package/@microsoft/dynwinrt-codegen)) |
